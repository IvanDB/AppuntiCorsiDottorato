...
\renewcommand {\P}	[0] {\mathbb{P}}	%Probability 
\newcommand {\expv}	[0] {\mathbb{E}}	%Expected value 
\newcommand {\gaus}	[0] {\mathcal{N}}	%Normal distributions 

\newcommand {\subGauss}	[0] {\mathcal{SG}}	%SubGaussian
\newcommand {\subGamma}	[0] {\mathcal{S}\Gamma}	%SubGamma
...
\DeclareMathOperator*{\GLim} {\Gamma-\lim}	%Gamma limit
...
\DeclareMathOperator {\starJ} {*J}			%Jacobian current

\DeclareMathOperator{\tr} {tr}				%Trace operator
\DeclareMathOperator{\srank}{srank}			%Stable rank function

\DeclareMathOperator{\Var} {Var}			%Variance of a v.a.

\DeclareMathOperator{\vspan} {span}			%Span of a set of vectors
...
\newcommand {\trasp}	[0] {\mathrm{T}}						%transpose symbol
\newcommand {\pd}	[0] {\succ}							%pos  def relation symbol
\newcommand {\psd}	[0] {\succeq}							%pos sdef relation symbol
\newcommand {\nd}	[0] {\prec}							%neg  def relation symbol
\newcommand {\nsd}	[0] {\preceq}							%neg sdef relation symbol
...
\newcommand {\argmin} [0] {\displaystyle\argMin}			%Supremum
\newcommand {\argmax} [0] {\displaystyle\argMax}			%Infimum
...
\newcommand {\Glim} 	[0] {\displaystyle\GLim}			%Generic Gamma limit
...
\newcommand {\colspan}	[1] {\left[\; #1 \;\right]}
